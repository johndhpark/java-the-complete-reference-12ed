...
class BlockArrowCase {
	public static void main(String[] args) {
		...
		// Use code blocks with an arrow. Again, notice that no break statement
		// is required (or allowed) to prevent fall through. Because the target of an
		// arrow is a block, yield must be used to supply the value.
