...
class HighTemp {
	...
	// Return true if the invoking HighTep object has a temperature that is less
	// than ht2.
...
public class InstanceMethWithObjectRefDemo {
	...
	public static void main(String[] args) {
		...
		// Create an array of HighTemp objets.
		...
		// Use counter() with arrays of the class HighTemp. Notice that a reference to
		// the instance method
		...
		// Now, create an use another array of HighTemp objects.
