...
// A functional interface that takes two reference arguments and return a boolean result.
interface MyFunc<T> {
...
class HighTemp {
	...
	// Return truen if the invoking HighTemp object has the same temperature as ht2.
	boolean sameTemp(HighTemp ht2) {
		return hTemp == ht2.hTemp;
	}

	// Return true if the invoking HighTemp object has a temperature that is than
	// ht2.
...
class InstanceMethWithObjectRefDemo {
	...
	public static void main(String[] args) {
		...
		// Creaate an array of HighTemp objects
		...
		HighTemp[] weekyDayHighs2 = { new HighTemp(32), new HighTemp(12), new HighTemp(24), new HighTemp(19),
				new HighTemp(18), new HighTemp(12), new HighTemp(-1), new HighTemp(13) };

		count = counter(weekyDayHighs2, HighTemp::sameTemp, new HighTemp(12));

		System.out.println(count + " days had a high of 12");

		// Now, use lessThanTemp() to find days when temperature was less than specified
		// value.
		count = counter(weekDayHighs, HighTemp::lessThanTemp, new HighTemp(89));

		System.out.println(count + " days had a high less than 89");

		count = counter(weekyDayHighs2, HighTemp::lessThanTemp, new HighTemp(19));
